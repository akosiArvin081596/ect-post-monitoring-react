...
export function InterviewerStep() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="mt-5 rounded-lg border border-gray-200 bg-gray-50 p-4 sm:mt-6 sm:p-5 dark:border-gray-700 dark:bg-gray-800">
      ...
      <div className="flex flex-col gap-3 pt-4 sm:flex-row">
        <button
          ...
          className="flex-1 rounded-lg border border-gray-300 px-5 py-4 text-base font-semibold text-gray-700 hover:bg-gray-50 disabled:opacity-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800"
        >
          Previous
        </button>
        <button
          ...
          className="flex-1 rounded-lg bg-green-600 px-5 py-4 text-base font-semibold text-white hover:bg-green-700 disabled:opacity-50"
        >
