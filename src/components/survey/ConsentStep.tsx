...
export function ConsentStep() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg bg-blue-50 p-4 sm:p-5 dark:bg-blue-900/20">
      ...
      <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 sm:p-5 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="flex gap-4">
          <button
            type="button"
            onClick={handleAgree}
            className="flex-1 rounded-lg bg-blue-600 px-5 py-4 text-base font-semibold text-white hover:bg-blue-700"
          >
            Yes, I Agree
          </button>
        </div>
