...
export function ExpenseBreakdownStep() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="border border-blue-200 bg-blue-50 p-5 dark:border-blue-800 dark:bg-blue-900/20">
      ...
      {variance < 0 && (
        <div className="border border-red-200 bg-red-50 p-4 text-base text-red-700 dark:border-red-800 dark:bg-red-900/20 dark:text-red-400">
